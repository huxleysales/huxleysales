        ...
        {loaded && <div>
            ...
            <div className="px-8 grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {data.products.map((product) => (
                    <a className="flex flex-col justify-center rounded-md drop-shadow-md bg-gradient-to-t from-cyan-500 dark:to-[#1b1b1d] min-h-[8rem]" href={`https://www.roblox.com/games/start?placeId=11746877837&launchData=${product.productID}`} target="_blank" style={{"textDecoration": "none"}}>
