...
If you were brought to this page after purchasing the `Bus Spawner Webhook Access` product, please make a Spawner support ticket.
...
Then, please make a Spawner support ticket.
...
Make sure you are selecting `Worker`, and then click **`Create Worker`**
...
<video controls playsinline style={{ maxWidth: "100%" }}>
  <source src="/video/docs/spawner/webhook/code.mp4" type="video/mp4" />
</video>
