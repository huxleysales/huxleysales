...
In your [configuration](/docs/spawner/configuration), you can see there is a value named `busModelSpawnType`. It is set to `"basic"` and recommended thst way for new users.
...
To see how to use the `"advanced"` option, [see here.](/docs/spawner/advanced-spawning)
