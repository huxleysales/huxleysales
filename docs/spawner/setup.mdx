...
In your [configuration](configuration), you can see there is a value named `busModelSpawnType`. It is set to `"basic"` and recommended thst way for new users.
...
To see how to use the `"advanced"` option, [see here.](advanced-spawning)
