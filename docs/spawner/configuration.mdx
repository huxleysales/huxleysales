...
| :------------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------------: | ---------------------------------------------------------------------------------: | -------------------------------------------------------------: | -----------------------------: |
| [theme](#theme-configuration-options)             | Includes all the data for your theme such as a title, custom logo image, and color themes! (Blue & Dark Theme are the best :sunglasses:) |                                   [ThemeConfig](/docs/spawner/typings#themeconfig) |    [View this for value choices](#theme-configuration-options) |                                |
| [categories](#category-configuration-options)     |                                          Includes all the data about the different categories.                                           |                           [CategoryConfigs](/docs/spawner/typings#categoryconfigs) | [View this for value choices](#category-configuration-options) |                                |
| [groupSettings](#group-configuration-options)     |                                Includes all the data about your group and group settings for the spawner.                                |                                   [GroupConfig](/docs/spawner/typings#groupconfig) |  [View this for value choices](#webhook-configuration-options) |                                |
| [webhookSettings](#webhook-configuration-options) |                                    Includes all the data about your webhook settings for the spawner.                                    |                               [WebhookConfig](/docs/spawner/typings#webhookconfig) |  [View this for value choices](#webhook-configuration-options) |                                |
...
| busModelSpawnType                                 |                The method of spawning a bus - if using advanced, see [Advanced Spawning](/docs/spawner/advanced-spawning)                |                                                                             string |                                         `"basic"`/`"advanced"` |                      `"basic"` |
...
| :--------------------- | :------- | :---------------------------------: | -----------------------------------------------------: |
| [Category1](#category) | yes      | Includes all the data for Category1 | [CategoryConfig](/docs/spawner/typings#categoryconfig) |
| [Category2](#category) | no       | Includes all the data for Category2 | [CategoryConfig](/docs/spawner/typings#categoryconfig) |
| [Category3](#category) | no       | Includes all the data for Category3 | [CategoryConfig](/docs/spawner/typings#categoryconfig) |
| [Category4](#category) | no       | Includes all the data for Category4 | [CategoryConfig](/docs/spawner/typings#categoryconfig) |
| [Category5](#category) | no       | Includes all the data for Category4 | [CategoryConfig](/docs/spawner/typings#categoryconfig) |
...
| categoryType | yes      |                      The Category Type                      | number | [CategoryTypeOption](/docs/spawner/typings#categorytypeoption) |      `nil` unless first - then `"open"` |
