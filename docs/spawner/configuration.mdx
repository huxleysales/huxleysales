...
```lua showLineNumbers tile="SpawnerConfig"
--!strict
...
local config: Typings.Config = {
	...
	webhookSettings = {
		enabled = false,
		receiver = "discord",
		url = "https://canary.discord.com/api/webhooks/"
	},
...
| [groupSettings](#gr oup-configuration-options) |                                Includes all the data about your group and group settings for the spawner.                                |                  [GroupConfig](/docs/rbx-products/bus-spawner/typings#groupconfig) |    [View this for value choices](#group-configuration-options) |                                |
