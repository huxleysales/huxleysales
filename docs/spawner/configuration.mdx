...
| [groupSettings](#group-configuration-options)     |                                Includes all the data about your group and group settings for the spawner.                                |                  [GroupConfig](/docs/rbx-products/bus-spawner/typings#groupconfig) |  [View this for value choices](#webhook-configuration-options) |                                |
| [webhookSettings](#webhook-configuration-options) |                                    Includes all the data about your webhook settings for the spawner.                                    |              [WebhookConfig](/docs/rbx-products/bus-spawner/typings#webhookconfig) |  [View this for value choices](#webhook-configuration-options) |                                |
...
| [Category5](#category) | no       | Includes all the data for Category4 | [CategoryConfig](/docs/rbx-products/bus-spawner/typings#categoryconfig) |
